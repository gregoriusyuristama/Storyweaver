...
class SE2Scene3: SKScene {
    ...
    @ObservedObject private var gameState = GameState(dialogTree: DialogTree.DialogTreeSE2Scene3)
...
//
//        // Sound Effect
        if gameState.currentDialog?.id == 7 || gameState.currentDialog?.id == 8{
